...
| **Source** | [sources/oil-data-bug-thread.pdf](sources/oil-data-bug-thread.pdf) (shared thread with sibling issue [BUMA-LOG-004](oil-changed-parameter-missing-since-api-move.md)) |
...
| 2026-08-06 09:25 PM† | Okky (BukitTech) | Reports both fixes already done in UAT; asks whether a CAB is required for these minor fixes. | Benedict Panizza |
...
| 2026-08-07 08:34 AM† | Okky (BukitTech) | Outlines the fix: implemented an HTML tag remover for the oil analysis sample Note (plus the sibling issue's fix). Will deploy to PRD shortly if no objection. | Benedict Panizza |
...
† *Printed as "12:25 AM" (Aug 7) and "11:34 AM" — quoted headers generated by Benedict's own Outlook (AEST, UTC+10) at reply-time, 3h ahead of Okky's WIB. Corrected: **09:25 PM WIB, Aug 6** and **08:34 AM WIB** respectively — see [oil-changed-parameter-missing-since-api-move.md](oil-changed-parameter-missing-since-api-move.md#timeline) for the full cross-check.*
...
- **2026-08-17:** Corrected two timestamps (12:25 AM Aug 7 → 09:25 PM Aug 6; 11:34 AM → 08:34 AM) after re-checking against the archived source PDF — see [BUMA-LOG-004](oil-changed-parameter-missing-since-api-move.md#revision-history) for the full detail (shared thread). SLA pause window recalculated from ~4h43m to ~7h43m accordingly.
