...
**Candidate scope — cuma Order yang sudah lolos Planner approval (2026-08-14):** Order yang **masih pending approval** (belum diproses Planner, `PoolingMOItem` belum pernah ter-insert — lihat [Bagian 5, Alur Sync ke SAP](../../architecture/inspection-order/order-emol-sap-sync.md#5-alur-sync-ke-sap-post-approval), yang jalan **post-approval**) **di-exclude dari kandidat suggestion**. Konsisten dengan asumsi [Sub-kasus A Poin 1](#poin-1-trigger-dan-ui-create-defect-atau-crack) bahwa Order lama yang direuse "sudah pernah lolos approval saat pertama kali dibuat". Detail sourcing description per kondisi ada di [UI View Detail — List Suggestion Order Lama](#ui-view-detail--list-suggestion-order-lama-2026-08-14).
