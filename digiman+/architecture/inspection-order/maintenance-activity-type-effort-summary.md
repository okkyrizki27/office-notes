...
| Master Data UI baru: `MaterialCostTypeActivityTypeMapping` (M:N Order Type ↔ Activity Type) | Sedang–Besar | 5 | 5.9 | CRUD + validasi M:N — pola sama dengan Master Data Area↔`ModelComponentSubComponent` di [area-of-unit-man-power-effort-summary.md](../area-of-unit-man-power-effort-summary.md) *(catatan: itu didesain sebagai 1:N via kolom `AreaCode`, bukan M:N — beda dari mapping M:N di baris ini)* |
...
| Digiman Transaction Report: tambah kolom `Maint. Act. Type` ke view Synapse (`vw_report_iams_f_am_digiman_dorder`, 4 titik CTE) — [maintenance-activity-type-enhancement.md](maintenance-activity-type-enhancement.md) 2.12 | Kecil | 1 | 1.2 | Passthrough dari `mechanicorderlist.maintenanceactivitytypecode`, sejajar pola kolom `MOType` yang sudah ada di view yang sama. Reference class **[DE]**: [IAMS30-3946](https://bukittechnology.atlassian.net/browse/IAMS30-3946) (Varian, 3 SP — "Enhance `vw_report_iams_f_am_digiman_dorder`", tambah 1 kolom + 1 tabel baru) — scope kita lebih kecil (1 kolom saja), 1 SP masuk akal |
| Update dataset/report Power BI — tampilkan kolom `Maint. Act. Type` baru | Kecil–Sedang | 2 | 2.3 | **✅ Dikoreksi 20 Jul 2026** — sitasi sebelumnya salah: [IAMS30-3946](https://bukittechnology.atlassian.net/browse/IAMS30-3946) itu sendiri adalah tiket **DE** (Varian, lihat baris di atas), bukan sisi PBI. Reference class **[DA]** yang benar: subtask-nya — [IAMS30-3950](https://bukittechnology.atlassian.net/browse/IAMS30-3950) (Herianto, 2 SP, "Adjust PBI based on WorkflowTransaction status") + [IAMS30-3980](https://bukittechnology.atlassian.net/browse/IAMS30-3980) (Herianto, 3 SP, "Add Last Sync in Dashboard") = **5 SP** untuk scope yang lebih besar dari sekadar 1 kolom (termasuk 1 tabel baru). Ditambah **bukti nyata stabilisasi pasca-rilis** dari fitur yang sama: 3 bug reopen — [IAMS30-4012](https://bukittechnology.atlassian.net/browse/IAMS30-4012) (Varian/DE, 2 SP), [IAMS30-4013](https://bukittechnology.atlassian.net/browse/IAMS30-4013) (Varian/DE, 1 SP), [IAMS30-4015](https://bukittechnology.atlassian.net/browse/IAMS30-4015) (Herianto/DA, unpointed). 2 SP di baris ini **kemungkinan under-estimate** dibanding reference class riil (5 SP) — tapi tidak diubah di sini karena scope kita cuma 1 kolom (lebih kecil dari preseden), buffer stabilisasi tetap relevan dipertimbangkan |
...
- [IAMS30-3946](https://bukittechnology.atlassian.net/browse/IAMS30-3946) — reference class Jira **[DE]** untuk baris SQL view report, dicek 17 Jul 2026, **detail dikoreksi 20 Jul 2026** (bukan PBI-side seperti sitasi awal — lihat baris tabel)
- [IAMS30-3950](https://bukittechnology.atlassian.net/browse/IAMS30-3950), [IAMS30-3980](https://bukittechnology.atlassian.net/browse/IAMS30-3980) — reference class Jira **[DA]** yang benar untuk baris "Update dataset/report Power BI" (subtask `IAMS30-3946`, Herianto Salim), dicek 20 Jul 2026
