...
- [Homepage Current State](homepage/homepage-current-state.md) — sections, formula count Needs Attention, kriteria per kategori (Inspection / PM Shutdown / BD Corrective), Settings, permission (post Release 4.0.0)
...
- [PM Shutdown Page Current State](pm-shutdown-bd-corrective/pm-shutdown-page-current-state.md) — kriteria data list, perubahan filter, permission (post Release 4.0.0)
- [BD Corrective Page Current State](pm-shutdown-bd-corrective/bd-corrective-page-current-state.md) — kriteria data list, perubahan filter, permission (post Release 4.0.0)
